...
async function main() {
  ...
  console.log(`✅ Created/verified ${courts.length} courts`)
  ...
  console.log(`✅ Created/verified ${equipments.length} equipment items`)
  ...
  console.log(`✅ Created/verified ${menuItems.length} menu items`)
  ...
  console.log(`✅ Created/verified ${coupons.length} coupons`)
